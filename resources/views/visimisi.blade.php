...
<head>
  ...
  <![endif]-->
	...
	<div class="gtco-section">
        ...
        <p style="text-align: center;">Himpunan Mahasiswa Jurusan Teknik Informatika STMIK AKAKOM Yogyakarta mengemban visi utama, yaitu sebagai wadah untuk menyatukan mahasiswa jurusan Teknik Informatika dalam menunjang proses akademis dan non akademis.</p>
        <h2 style="text-align: center;">MISI</h2>
        <p style="text-align: center;">Mengembangkan kepribadian, skill, kreativitas dan pengetahuan.<br>Berfungsi sebagai fasilitator dan sumber wacana untuk memperluas wawasan di bidang teknologi informasi.</p>
        </div>
			</div>
</div>
</div>
