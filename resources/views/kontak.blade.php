		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-6 animate-box">
					<h3>HMJ TI STMIK Akakom Yogyakarta</h3>
					<form action="#">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="subject" class="form-control" placeholder="Judul Email">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Tulis Saran / Masukan"></textarea>
							</div>
						</div>
          ...
          <div class="gtco-contact-info">
            <h2>Kontak Kami</h2>
            <ul>
              <li class="phone"><a href="https://api.whatsapp.com/send?phone=6281390301214">+ 62 8139 0301 214</a></li>
              <li class="email"><a href="https://mail.google.com/mail/?view=cm&fs=1&to=hmjti.stmikakakom@gmail.com">hmjti.stmikakakom@gmail.com</a></li>
              <li class="url"><a href="https://hmjti.akakom.ac.id/">hmjti.akakom.ac.id</a></li>
            </ul>
          </div>
				</div>
			</div>
