        ...
        <div class="row animate-box">
          <div class="artikel">
            <div class="col-md-3 col-md-push-9">
              <h4 class="">Cari Kegiatan</h4>
              <form method="get" action="/kegiatan/cari" enctype="multipart/form-data">
              ...
              <div class="marginbot-bottom30"></div>
                          ...
                          <td style="padding-right: 10px;"><img src="https://hmjti.akakom.ac.id/assets/img/user-placeholder.png" class="img-responsive img-circle"></td>
                            <td style="padding-top: 10px">
                                ...
                                <small class="text-muted">
                                    ...
                                    Ditulis pada {{$kegiatan->tanggal_kegiatan}}                                   <br>
                                    <i class="fa fa-folder" aria-hidden="true"></i>&nbsp;
                                    Tempat Kegiatan : {{$kegiatan->tempat_kegiatan}}</a>
                                </small>
                                </p>
                            </td>
                        </tr>
                ...
                <h1>
                    ...
                    <img src="{{asset('/foto_kegiatan/'.$gambar) }}" class="img-responsive" style="width: 100%">
                    <?php } ?>
            </div>
            <div class="post-read"><p>{{$kegiatan->deskripsi}}</p></div>
            <div class="marginbot-bottom30">&nbsp;</div>
        </div>
                      </div>
                    </div>
