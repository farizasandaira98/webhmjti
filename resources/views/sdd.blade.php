...
<head>
  ...
  <![endif]-->
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>Skill Development Division</h1>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="gtco-section">
        ...
        <p style="text-align: center;">Skill Development Division HMJ TI STMIK AKAKOM Yogyakarta bertugas untuk mengembangkan keahlian dan ketrampilan baik yang bersifat ilmiah maupun non ilmiah.</p>
        </div>
			</div>
</div>
</div>
