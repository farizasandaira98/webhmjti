...
<head>
  ...
  <![endif]-->
          ...
          <ul>
            ...
            <li class="has-dropdown active">
              ...
              <ul class="dropdown">
                ...
                <li class = "active-dropdown"><a href="/networking">Networking Division</a></li>
	...
	<div class="gtco-section">
        ...
        <p style="text-align: center;">Networking Division HMJ TI STMIK AKAKOM Yogyakarta bertugas menjalin kerjasama dan menjadi penghubung HMJ TI STMIK AKAKOM Yogyakarta dengan pihak di luar STMIK AKAKOM Yogyakarta.</p>
        </div>
			</div>
</div>
</div>
<div id="gtco-features-2">
	<div class="gtco-container">
		<div class="row animate-box">
			<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
				<h2>Program Kerja Networking</h2>
			</div>
		</div>
