...
<head>
  ...
  <![endif]-->
		...
		<div class="gtco-container">
          ...
          <ul>
            ...
            <li class="has-dropdown active">
              <a>Divisi</a>
              <ul class="dropdown">
                <li class = "active-dropdown"><a href="/internal">Internal Division</a></li>
	...
	<div class="gtco-section">
        ...
        <p style="text-align: center;">Internal Division HMJ TI STMIK AKAKOM Yogyakarta bertugas untuk menangani masalah keanggotaan dan menjalankan hubungan di dalam kampus STMIK AKAKOM Yogyakarta.</p>
        </div>
			</div>
</div>
</div>
