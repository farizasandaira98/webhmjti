          ...
          <ul>
            ...
            <li class="has-dropdown active">
              ...
              <ul class="dropdown">
                ...
                <li class = "active-dropdown"><a href="/sejarah">Sejarah</a></li>
