					...
					<div class="col-md-12 col-md-offset-0 text-center">
						<div class="display-t">
							<div class="display-tc animate-box" data-animate-effect="fadeIn">
								...
								<h2>Di Situs Himpunan Mahasiswa Jurusan Teknik Informatika STMIK Akakom Yogyakarta</h2>
								<p>
								</div>
							</div>
						</div>
				...
				<div class="gtco-container">
					<div class="row animate-box">
						<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
							<h2>Divisi Kami</h2>
							<p>Terdapat 3 divisi yang ada pada Himpunan Mahasiswa Jurusan Teknik Informatika STMIK Akakom Yogyakarta</p>
						</div>
						<div class="col-md-4 col-sm-4">
							<div class="feature-center animate-box" data-animate-effect="fadeIn">
								...
								<p><a href="/internal" class="btn btn-primary btn-outline">Detail</a></p>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							<div class="feature-center animate-box" data-animate-effect="fadeIn">
								...
								<h3>Networking Division</h3>
								<p><a href="/networking" class="btn btn-primary btn-outline">Detail</a></p>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							<div class="feature-center animate-box" data-animate-effect="fadeIn">
								...
								<h3>Skill Development Division</h3>
								<p><a href="/sdd" class="btn btn-primary btn-outline">Detail</a></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="owl-carousel owl-carousel-fullwidth ">
				<div class="item">
					<div class="testimony-slide active text-center">
						...
						<span>Abang Samsul</span>
						<blockquote>
							<p>&ldquo;Hidup Seperti Larry.&rdquo;</p>
						</blockquote>
					</div>
				</div>
				<div class="item">
