              ...
              <div class="marginbot-bottom30"></div>
                    ...
                    @foreach($kegiatan as $keg)
                      <div class="row wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="col-sm-4">
                            <div class="post-thumbnail">
                              ...
                              foreach ($foto as $gambar){ ?>
                                <img src="{{asset('/foto_kegiatan/'.$gambar) }}" class="img-responsive img-thumbnail">
                              <?php } ?>
                            </div>
                          </a>
                        </div>
                        <div class="col-sm-8">
                          <h3 class="title">
                            <a href="/kegiatan/{{$keg->id}}" title="{{$keg->nama_kegiatan}}">
                            {{$keg->nama_kegiatan}}</a>
                            </h3>
                            <small class="text-muted">
                              <span class="glyphicon glyphicon-calendar"></span>&nbsp;
                              Ditulis Pada {{$keg->tanggal_kegiatan}} <p style="margin-top: 5px">
                                <i class="fa fa-folder" aria-hidden="true"></i>
                                Tempat Kegiatan : {{$keg->tempat_kegiatan}}
                                </p>
                              </small>
                              ...
                              <p class="text-muted hidden-xs">
                                <a href="/kegiatan/{{$keg->id}}" class="btn btn-danger">Baca Selengkapnya <i class="fa fa-plus" aria-hidden="true"></i></a>
                              </p>
                            </div>
                          </div>
                          <hr>
