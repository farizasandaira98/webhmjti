...
<head>
  ...
  <title>Admin HMJ TI STMIK Akakom Yogyakarta | Data Pemasukan</title>
...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="/admin/pemasukan" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="/admin/pemasukan/tambah" class="btn btn-danger">Input Pemasukan Baru</a>
      <a href="/admin/pemasukan/export_excel" class="btn btn-danger">Export Data Pemasukan Ke Excel</a>
      </br></br>
      <div class="card">
              <div class="card-body">
                <table>
