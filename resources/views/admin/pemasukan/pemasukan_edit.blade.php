...
<head>
    ...
    <title>Edit Data Pemasukan</title>
</head>
<body>
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                Data Pemasukan HMJ TI - <strong>EDIT DATA</strong>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="/admin/pemasukan/update/{{$pemasukan->id}}" enctype="multipart/form-data">

                    {{ csrf_field() }}
                    <div class="form-group">
                        <label>Nomor Nota</label>
                        <input type="text" name="nomor_nota" class="form-control" placeholder="Nomor Nota .."
                        value="{{$pemasukan->nomor_nota}}">
