...
<head>
  ...
  <title>Admin HMJ TI STMIK Akakom Yogyakarta | Dashboard</title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h5 class="m-0" style="font-weight:10;">Dihalaman Admin Web HMJ TI STMIK Akakom Yogyakarta</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
     ...
     <!-- Row Keanggotaan -->
      <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>{{$sumanggotainti}}</h3>
                <p>Total Anggota Inti</p>
              </div>
              <div class="icon">
                <i class="ion ion-ios-people"></i>
              </div>
              <a href="/admin/anggota" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
      ...
      <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="/admin/kegiatan" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="/admin/artikel" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
      ...
      <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>{{$sumbarang}}</h3>
                <p>Jumlah Inventaris Barang</p>
              </div>
              <div class="icon">
                <i class="ion ion-android-folder"></i>
              </div>
              <a href="/admin/inventaris" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="/admin/suratmasuk" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="/admin/suratkeluar" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
      ...
      <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="/admin/pengeluaran" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
