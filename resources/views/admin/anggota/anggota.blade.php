...
<head>
  ...
  <title>Admin HMJ TI STMIK Akakom Yogyakarta | Data Anggota</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="/admin/anggota/cari" enctype="multipart/form-data">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="/admin/anggota/tambah" class="btn btn-danger">Input Anggota Baru</a>
