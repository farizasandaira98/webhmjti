    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                Data inventaris HMJ TI - <strong>EDIT DATA</strong>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="/admin/inventaris/update/{{$inventaris->id}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        value="{{$inventaris->sumber_barang}}">
