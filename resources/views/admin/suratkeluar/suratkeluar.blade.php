...
<head>
  ...
  <title>Admin HMJ TI STMIK Akakom Yogyakarta | Surat Keluar</title>
  ...
  <link rel="stylesheet" href="{{asset('assets/admin/dist/css/csssuratkeluar.css')}}">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="/admin/suratkeluar/cari" enctype="multipart/form-data">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              ...
              <li class="nav-item">
                <a href="/admin/suratkeluar" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="/admin/suratkeluar/tambah" class="btn btn-danger">Input Surat Keluar Baru</a>
      <a href="/admin/suratkeluar/cetak" class="btn btn-danger">Cetak Surat Keluar</a>
      </br></br>
      <div class="card">
              <div class="card-body">
                <table>
                  ...
                  @foreach($suratkeluar as $ang)
                    ...
                    <td>{{ $ang->tujuan}}</td>
                    <td>
                      <a href="/admin/suratkeluar/edit/{{ $ang->id }}" class="btn btn-warning" style="width:100%;">Edit</a></br></br>
                      <a href="/admin/suratkeluar/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                    </td>
                    </tr>
                    @endforeach
                  </tbody>
