    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                Data Artikel HMJ TI - <strong>EDIT DATA</strong>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="/admin/artikel/update/{{$artikel->id}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi ..">{{$artikel->deskripsi}}</textarea>
