...
<head>
  ...
  <title>Admin HMJ TI STMIK Akakom Yogyakarta | Data Artikel</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="/admin/artikel/tambah" class="btn btn-danger">Input Artikel Baru</a>
      </br></br>
      <div class="card">
              <div class="card-body">
                <table>
                  ...
                  <tbody>
                  @foreach($artikel as $ang)
                    <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $ang->judul_artikel }}</td>
                    <td>{{ $ang->deskripsi }}</td>
                    <td>{{ $ang->sumber }}</td>
