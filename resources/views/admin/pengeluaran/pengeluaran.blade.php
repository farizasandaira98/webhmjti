...
<head>
  ...
  <title>Admin HMJ TI STMIK Akakom Yogyakarta | Data Pengeluaran</title>
  ...
  <link rel="stylesheet" href="{{asset('assets/admin/dist/css/cssuangkeluar.css')}}">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="/admin/artikel/cari" enctype="multipart/form-data">
        <div class="input-group input-group-sm">
          <input class="form-control form-control-navbar" type="search" placeholder="Cari" aria-label="Search" name="search">
          <input type placeholder="Masukkan Tanggal Pencarian" class="textbox-n" type="text" onfocus="(this.type='date')" id="date" name="datekeg" class="form-control datepicker">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              ...
              <li class="nav-item">
                <a href="/admin/pengeluaran" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="/admin/pengeluaran/tambah" class="btn btn-danger">Input Pengeluaran Baru</a>
      <a href="/admin/pengeluaran/export_excel" class="btn btn-danger">Export Data Pengeluaran Ke Excel</a>
      </br></br>
      <div class="card">
              <div class="card-body">
                <table>
                  ...
                  @foreach($pengeluaran as $ang)
                    ...
                    <td>{{ $ang->nomor_nota }}</td>
                    <td>{{ $ang->jumlah_pengeluaran}}</td>
                    <td>{{ $ang->tanggal_pengeluaran }}</td>
                    <td>{{ $ang->keperluan }}</td>
                    <td><a href="{{asset('/foto_nota_keluar/'.$ang->nota) }}"><img id="myImg" src="{{asset('/foto_nota_keluar/'.$ang->nota) }}" style='width:140px; height:160px;'></a></td>
                    <td>{{ $ang->periode }}</td>
                  </td>
                    <td>
                      <a href="/admin/pengeluaran/edit/{{ $ang->id }}" class="btn btn-warning" style="width:100%;">Edit</a></br></br>
                      <a href="/admin/pengeluaran/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                    </td>
                    </tr>
                    @endforeach
                    <tr>

                    <td colspan='7'>Total Pengeluaran HMJ TI : {{ $sumpengeluaran }}</td>
