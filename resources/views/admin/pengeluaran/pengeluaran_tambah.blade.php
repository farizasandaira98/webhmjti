    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                Data Pengeluaran HMJ TI - <strong>TAMBAH DATA</strong>
            </div>
            <div class="card-body">
                <a href="/admin/pengeluaran" class="btn btn-danger">Kembali</a>
                <br/>
                <br/>

                <form method="post" action="/admin/pengeluaran/store" enctype="multipart/form-data">
