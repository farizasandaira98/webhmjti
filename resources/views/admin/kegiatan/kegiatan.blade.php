...
<head>
  ...
  <title>Admin HMJ TI STMIK Akakom Yogyakarta | Data Kegiatan</title>
  ...
  <link rel="stylesheet" href="{{asset('assets/admin/dist/css/csskegiatan.css')}}">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="/admin/kegiatan/cari" enctype="multipart/form-data">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="/admin/kegiatan" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="/admin/kegiatan/tambah" class="btn btn-danger">Input Kegiatan Baru</a>
      </br></br>
      <div class="card">
              <div class="card-body">
                <table>
                  <thead>
                    <tr style="text-align: center;">
                      ...
                      <th>Divisi Kegiatan</th>
                      <th style="width:25%">Foto Kegiatan</th>
                      <th >Aksi</th>
                    </tr>
                  </thead>
                  <tbody>
                  @foreach($kegiatan as $ang)
                    ...
                    if ($stat == '1') {
                      ...
                      $status = "Skill Development Division";
                    }elseif ($stat == '3'){
                        $status = "Networking Division";
                    }elseif ($stat == '4'){
                        $status = "Umum";
                    }else{
                        $status = "Lupa Keisi";
                    ...
                    <td><?php foreach (json_decode($ang->foto_kegiatan)as $gambar){ ?>
                      <a href="{{asset('/foto_kegiatan/'.$gambar) }}"><img id="myImg"
                      src="{{asset('/foto_kegiatan/'.$gambar) }}" style='width:80px; height:120px;'></a>
                    <?php } ?>
                  </td>
                    <td>
                      <a href="/admin/kegiatan/edit/{{ $ang->id }}" class="btn btn-warning" style="width:100%;">Edit</a></br></br>
                      <a href="/admin/kegiatan/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                    </td>
                    </tr>
                    @endforeach
                  </tbody>
