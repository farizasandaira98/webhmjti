...
<head>
  ...
  <title>Admin HMJ TI STMIK Akakom Yogyakarta | Surat Masuk</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="/admin/suratmasuk/cari" enctype="multipart/form-data">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              ...
              <li class="nav-item">
                <a href="/admin/suratmasuk" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
      <a href="/admin/suratmasuk/tambah" class="btn btn-danger">Input Surat Masuk Baru</a>
      <a href="/admin/suratmasuk/cetak" class="btn btn-danger">Cetak Surat Masuk</a>
      </br></br>
      <div class="card">
              <div class="card-body">
