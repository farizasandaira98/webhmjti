		...
		<div class="gtco-container">
          ...
          <ul>
            ...
            <li class="has-dropdown active">
              <a>Tentang Kami</a>
              <ul class="dropdown">
                <li class = "active-dropdown"><a href="/profil">Profil</a></li>
		...
		<div class="gtco-container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<p style="text-align: center;">Perkembangan teknologi informasi melaju seiring perkembangan zaman. Dengan maraknya perkembangan tersebut, kebutuhan ilmu ini pun akan semakin meningkat. Teknik Informatika sebagai salah satu jurusan di STMIK AKAKOM Yogyakarta yang berkonsentrasi dalam bidang teknologi informasi dituntut untuk mampu mengikuti dan mampu mengembangkan trend di bidang tersebut. Untuk merealisasikan visi dan misi maka diperlukan suatu wadah yang merupakan bentuk kristalisasi kesamaan dasar pemikiran dan aspirasi mahasiswa khususnya jurusan Teknik Informatika, yakni Himpunan Mahasiswa Jurusan Teknik Informatika. Dengan dibentuknya Himpunan Mahasiswa Jurusan Teknik Informatika diharapkan menjadi modal untuk menentukan sasaran dibidang teknologi informasi dan menjadi bekal untuk bersaing di dunia kerja sehingga dapat memenuhi tuntutan zaman di bidang teknologi informasi.</p>
				</div>
			</div>
</div>
</div>
